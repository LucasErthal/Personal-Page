...
const ColetaAmiga: React.FC = () => {
  return (
    <div id="coleta-amiga">
      <h2>Coleta Amiga</h2>

      <p>
        Foi meu primeiro projeto mobile após estudar pelo evento da
      ...
      <p>
        O projeto foi feito em React Native utilizando Typescript,
      ...
      <p>
        A parte de localidade e rotas foi um bom desafio por se tratar de um iniciante tanto
